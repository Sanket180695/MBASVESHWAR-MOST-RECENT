...
import { NgZorroAntdModule, NZ_I18N, en_US, NzRadioModule } from 'ng-zorro-antd';
...
import { GuarantorComponent } from './pages/PersonalProposal/guarantor/guarantor.component';
import { GpersonalComponent } from './pages/Guarantor/gpersonal/gpersonal.component';
import { GincomeComponent } from './pages/Guarantor/gincome/gincome.component';
import { GfinancialComponent } from './pages/Guarantor/gfinancial/gfinancial.component';
import { GcreditComponent } from './pages/Guarantor/gcredit/gcredit.component';
import { GpropertyComponent } from './pages/Guarantor/gproperty/gproperty.component';
import { GproposalComponent } from './pages/Guarantor/gproposal/gproposal.component';

import { IncomeSalaryComponent } from './pages/Guarantor/income-salary/income-salary.component';
import { IncomeBusinessComponent } from './pages/Guarantor/income-business/income-business.component';
import { IncomeAgricultureComponent } from './pages/Guarantor/income-agriculture/income-agriculture.component';
import { IncomeHouseComponent } from './pages/Guarantor/income-house/income-house.component';
import { IncomeOtherComponent } from './pages/Guarantor/income-other/income-other.component';
import { IncomeExpenditureComponent } from './pages/Guarantor/income-expenditure/income-expenditure.component';
// LoanoffComponent

import { GfsavingComponent } from './pages/Guarantor/gfsaving/gfsaving.component';
import { GftermdepositComponent } from './pages/Guarantor/gftermdeposit/gftermdeposit.component';
import { GfcurrentdepositComponent } from './pages/Guarantor/gfcurrentdeposit/gfcurrentdeposit.component';
import { GfrecurringdepositComponent } from './pages/Guarantor/gfrecurringdeposit/gfrecurringdeposit.component';

import { CreditLoanFromThisBankComponent } from './pages/Guarantor/credit-loan-from-this-bank/credit-loan-from-this-bank.component';
import { CreditLoanFromOtherBankComponent } from './pages/Guarantor/credit-loan-from-other-bank/credit-loan-from-other-bank.component';
import { CreditLoanGuaranteeComponent } from './pages/Guarantor/credit-loan-guarantee/credit-loan-guarantee.component';
import { CreditPreviousLoanComponent } from './pages/Guarantor/credit-previous-loan/credit-previous-loan.component';

import { GPropertiesToAddComponent } from './pages/Guarantor/g-properties-to-add/g-properties-to-add.component';

import { SendFromLocalBoardToHoComponent } from './pages/PersonalProposal/send-from-local-board-to-ho/send-from-local-board-to-ho.component';
import { SendToValuationStageComponent } from './pages/PersonalProposal/send-to-valuation-stage/send-to-valuation-stage.component';
import { SendToLegalOpinionComponent } from './pages/PersonalProposal/send-to-legal-opinion/send-to-legal-opinion.component';

import { GnCreditInfoComponent } from './pages/GuarantorNew/gn-credit-info/gn-credit-info.component';
import { GnDocumentInfoComponent } from './pages/GuarantorNew/gn-document-info/gn-document-info.component';
import { GnFinancialInfoComponent } from './pages/GuarantorNew/gn-financial-info/gn-financial-info.component';
import { GnIncomeInfoComponent } from './pages/GuarantorNew/gn-income-info/gn-income-info.component';
import { GnOtherComponent } from './pages/GuarantorNew/gn-other/gn-other.component';
import { GnPersonalInfoComponent } from './pages/GuarantorNew/gn-personal-info/gn-personal-info.component';
import { GnPropertiesAddComponent } from './pages/GuarantorNew/gn-properties-add/gn-properties-add.component';
import { GnPropertiesComponent } from './pages/GuarantorNew/gn-properties/gn-properties.component';
import { GnPropertyInfoComponent } from './pages/GuarantorNew/gn-property-info/gn-property-info.component';
import { GnProposalInfoComponent } from './pages/GuarantorNew/gn-proposal-info/gn-proposal-info.component';
import { GuarantorNewInfoComponent } from './pages/GuarantorNew/guarantor-new-info/guarantor-new-info.component';
...
@NgModule({
  declarations: [
    ...
    IncomeAgricultureComponent,
    IncomeHouseComponent,      
    IncomeOtherComponent,
    IncomeExpenditureComponent,

    GfsavingComponent,
    GftermdepositComponent,
    GfcurrentdepositComponent,
    GfrecurringdepositComponent,

    CreditLoanFromThisBankComponent,
    CreditLoanFromOtherBankComponent,
    CreditLoanGuaranteeComponent,
    CreditPreviousLoanComponent,

    GPropertiesToAddComponent,

    SendFromLocalBoardToHoComponent,
    SendToValuationStageComponent,
    SendToLegalOpinionComponent,

    GnCreditInfoComponent,
    GnDocumentInfoComponent,
    GnFinancialInfoComponent,
    GnIncomeInfoComponent,
    GnOtherComponent,
    GnPersonalInfoComponent, 
    GnPropertiesAddComponent,
    GnPropertiesComponent,
    GnPropertyInfoComponent,
    GnProposalInfoComponent,
    GuarantorNewInfoComponent
