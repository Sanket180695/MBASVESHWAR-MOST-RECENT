...
import { GuarantorMain } from '../Models/PersonalProposal/guarantor-main';
import { GuarantorPersonal } from '../Models/PersonalProposal/guarantor-personal';
import { GincomeComponent } from '../pages/Guarantor/gincome/gincome.component';
import { GuarantorIncome } from '../Models/PersonalProposal/guarantor-income';
import { GIncomeSource } from '../Models/PersonalProposal/g-income-source';
import { GuarantorSalariedInfo } from '../Models/PersonalProposal/guarantor-salaried-info';
import { GuarantorBusinessInfo } from '../Models/PersonalProposal/guarantor-business-info';
import { GuarantorAgriInfo } from '../Models/PersonalProposal/guarantor-agri-info';
import { GuarantorHouseInfo } from '../Models/PersonalProposal/guarantor-house-info';
import { GuarantorOtherInfo } from '../Models/PersonalProposal/guarantor-other-info';
import { GuarantorExpenditureInfo } from '../Models/PersonalProposal/guarantor-expenditure-info';
import { GuarantorFinancial } from '../Models/PersonalProposal/guarantor-financial';
import { GuarantorAllDeposits } from '../Models/PersonalProposal/guarantor-all-deposits';
import { GuarantorCredit } from '../Models/PersonalProposal/guarantor-credit';
import { GcLoanFromThisBank } from '../Models/PersonalProposal/gc-loan-from-this-bank';
import { GcLoanFromOthersBank } from '../Models/PersonalProposal/gc-loan-from-others-bank';
import { GcLoanGuarantee } from '../Models/PersonalProposal/gc-loan-guarantee';
import { GcPreviousLoan } from '../Models/PersonalProposal/gc-previous-loan';
import { GuarantorProperty } from '../Models/PersonalProposal/guarantor-property';
import { GuarantorSubproperty } from '../Models/PersonalProposal/guarantor-subproperty';
import { Sort } from '../Models/PersonalProposal/sort';
import { GnPersonal } from '../Models/PersonalProposal/gn-personal';
import { Banker } from '../Models/PersonalProposal/banker';
import { Employer } from '../Models/PersonalProposal/employer';
import { GIDSort } from '../Models/PersonalProposal/G_ID_sort';
import { GnGuarantor } from '../Models/PersonalProposal/gn-guarantor';
import { GnProperty } from '../Models/PersonalProposal/gn-property';
import { OtherIncome } from '../Models/PersonalProposal/other-income';
...
export class ApiService {
  ...
  sanctionFkey2 = "IitFSCMB"
  documentFkey = "lwO9LsuY"

  localBoardFkey = "IitQBASA"
  valuationFkey = "IitQBASV"
  ...
  updateNote(reportUrl: string, proposalId: number, currentStageId: number, nextStageId: number, remark: string, isCompleted): Observable<number> {
    var data = {
    ...
    return this.httpClient.post<number>(this.url + "praposal/updateNote", JSON.stringify(data), this.options);
  }

  updateValuationNote(valuationReportUrl: string, proposalId: number, currentStageId: number, nextStageId: number, remark: string, isCompleted): Observable<number> {
    var data = {
      VALUATIION_REPORT_URL: valuationReportUrl,
      PROPOSAL_ID: proposalId,
      CURRENT_STAGE_ID: currentStageId,
      NEXT_STAGE_ID: nextStageId,
      REMARK_VALUATION_STAGE: remark,
      IS_COMPLETED: isCompleted,
      USER_ID: this.userId
    };
    return this.httpClient.post<number>(this.url + "praposal/updateValuationNote", JSON.stringify(data), this.options);
  }

  updateLegalOpinionNote(legalOpinionReportUrl: string, proposalId: number, currentStageId: number, nextStageId: number, remark: string, isCompleted): Observable<number> {
    var data = {
      LEGAL_OPINION_REPORT_URL: legalOpinionReportUrl,
      PROPOSAL_ID: proposalId,
      CURRENT_STAGE_ID: currentStageId,
      NEXT_STAGE_ID: nextStageId,
      REMARK_VALUATION_STAGE: remark,
  ...
  getAllgIncomeInformation(pageIndex: number, pageSize: number, sortKey: string, sortValue: string, filter: string): Observable<GuarantorIncome[]> {
    var data = {
      pageIndex: pageIndex,
      pageSize: pageSize,
      sortKey: sortKey,
    ...
    return this.httpClient.post<GuarantorIncome[]>(this.url + "guarantorIncome/get", JSON.stringify(data), this.options);
  }
  ...
  updateSendToHo( recommend_amount:number, resolution_date: any,currentStageId: number, nextStageId: number, remark: string, proposalId: number,isCompleted): Observable<number> {
    var data ={
    ...
    return this.httpClient.post<number>(this.url + "praposal/updateSendToHo", JSON.stringify(data), this.options);
  }

  updateSendToValuation(currentStageId: number, nextStageId: number, remark: string, proposalId: number,isCompleted){
    var data ={
      CURRENT_STAGE_ID: currentStageId,
      NEXT_STAGE_ID: nextStageId,
      REMARK_VALUATION_STAGE :remark,
    ...
    return this.httpClient.post<number>(this.url + "praposal/updateSendToValuation", JSON.stringify(data), this.options);
  }

  updateLegalOpinion( sanction_amount:number,currentStageId: number, nextStageId: number, remark: string, proposalId: number,isCompleted): Observable<number> {
    var data ={
      SANCTION_AMOUNT1:sanction_amount,
      CURRENT_STAGE_ID: currentStageId,
      NEXT_STAGE_ID: nextStageId,
      REMARK_LEGAL_OPINION: remark,
      PROPOSAL_ID: proposalId,
      USER_ID: this.userId,
      IS_COMPLETED: isCompleted
    };
    return this.httpClient.post<number>(this.url + "praposal/updateLegalOpinion", JSON.stringify(data), this.options);
  }
  ...
  updateLoanDisbursement( currentStageId: number, nextStageId: number, remark: string, proposalId: number, isCompleted,PROPOSAL_REPORT, disbursement_date:any, maturity_due_date:any ): Observable<number> {
    var data = {
      CURRENT_STAGE_ID: currentStageId,
      NEXT_STAGE_ID: nextStageId,
      LOAN_DISBURSEMENT_REMARK: remark,
      USER_ID: this.userId,
      PROPOSAL_ID: proposalId,
      PROPOSAL_REPORT: PROPOSAL_REPORT,
      IS_COMPLETED: isCompleted,
      MATURITY_DUE : disbursement_date,
      MATURITY_DUE_DATE : maturity_due_date
    };
    return this.httpClient.post<number>(this.url + "praposal/updateLoanDisbursement", JSON.stringify(data), this.options);
  }
  ...
  getAllGuarantorSalariedInformation(GUARANTOR_INCOME_INFORMATION_ID){
    let data = {
      GUARANTOR_INCOME_INFORMATION_ID : GUARANTOR_INCOME_INFORMATION_ID
    } 
    return this.httpClient.post(this.url + "guarantorSalariedInformation/get", data, this.options);
  }

  createGuarantorSalariedInformation(data:GuarantorSalariedInfo){
    
    return this.httpClient.post<number>(this.url + "guarantorSalariedInformation/create/", data ,this.options);
  }

  updateGuarantorSalariedInformation(data:GuarantorSalariedInfo){
    return this.httpClient.post<number>(this.url + "guarantorSalariedInformation/update/", data ,this.options);
  }



  getGuarantorBusinessInformation(GUARANTOR_INCOME_INFORMATION_ID){
    let data = {
      GUARANTOR_INCOME_INFORMATION_ID : GUARANTOR_INCOME_INFORMATION_ID
    } 
    return this.httpClient.post(this.url + "guarantorBusinessInformation/get", data, this.options);
  }

  createGuarantorBusinessInformation(data:GuarantorBusinessInfo){
    
    return this.httpClient.post<number>(this.url + "guarantorBusinessInformation/create/", data ,this.options);
  }

  updateGuarantorBusinessInformation(data:GuarantorBusinessInfo){
    return this.httpClient.post<number>(this.url + "guarantorBusinessInformation/update/", data ,this.options);
  }



  getGuarantorAgricultureInformation(GUARANTOR_INCOME_INFORMATION_ID){
    let data = {
      GUARANTOR_INCOME_INFORMATION_ID : GUARANTOR_INCOME_INFORMATION_ID
    } 
    return this.httpClient.post(this.url + "guarantorAgriInfo/get", data, this.options);
  }

  createGuarantorAgricultureInformation(data:GuarantorAgriInfo){
    
    return this.httpClient.post<number>(this.url + "guarantorAgriInfo/create/", data ,this.options);
  }

  updateGuarantorAgricultureInformation(data:GuarantorAgriInfo){
    return this.httpClient.post<number>(this.url + "guarantorAgriInfo/update/", data ,this.options);
  }


  getGuarantorHouseInformation(GUARANTOR_INCOME_INFORMATION_ID){
    console.log(GUARANTOR_INCOME_INFORMATION_ID)

    let data= {
      GUARANTOR_INCOME_INFORMATION_ID : GUARANTOR_INCOME_INFORMATION_ID
    } 
    return this.httpClient.post(this.url + "guarantorHouseInfo/get", data, this.options);
  }

  createGuarantorHouseInformation(data:GuarantorHouseInfo){
    
    return this.httpClient.post<number>(this.url + "guarantorHouseInfo/create/", data ,this.options);
  }

  updateGuarantorHouseInformation(data:GuarantorHouseInfo){
    return this.httpClient.post<number>(this.url + "guarantorHouseInfo/update/", data ,this.options);
  }


  getGuarantorOtherInformation(GUARANTOR_INCOME_INFORMATION_ID){
    let data = {
      GUARANTOR_INCOME_INFORMATION_ID : GUARANTOR_INCOME_INFORMATION_ID
    } 
    return this.httpClient.post(this.url + "guarantorOtherInfo/get", data, this.options);
  }

  createGuarantorOtherInformation(data:GuarantorOtherInfo){
    
    return this.httpClient.post<number>(this.url + "guarantorOtherInfo/create/", data ,this.options);
  }

  updateGuarantorOtherInformation(data:GuarantorOtherInfo){
    return this.httpClient.post<number>(this.url + "guarantorOtherInfo/update/", data ,this.options);
  }


  getGuarantorExpenditureInformation(GUARANTOR_INCOME_INFORMATION_ID){
    let data = {
      GUARANTOR_INCOME_INFORMATION_ID : GUARANTOR_INCOME_INFORMATION_ID
    } 
    return this.httpClient.post(this.url + "guarantorExpenditureInformation/get", data, this.options);
  }

  createGuarantorExpenditureInformation(data:GuarantorExpenditureInfo){
    
    return this.httpClient.post<number>(this.url + "guarantorExpenditureInformation/create/", data ,this.options);
  }

  updateGuarantorExpenditureInformation(data:GuarantorExpenditureInfo){
    return this.httpClient.post<number>(this.url + "guarantorExpenditureInformation/update/", data ,this.options);
  }
  ...
  getGuarantorFinancialInformation(G_ID){
    let data = {
      G_ID:G_ID
    } 
    return this.httpClient.post(this.url + "guarantorFinancial/get", data, this.options);
  }

  createGuarantorFinancialInformation(data: GuarantorFinancial){
    return this.httpClient.post(this.url + "guarantorFinancial/create", data, this.options);
  }

  updateGuarantorFinancialInformation(data: GuarantorFinancial){
    
    return this.httpClient.post<number>(this.url + "guarantorFinancial/update/", data , this.options);
  }



  getGuarantorTermInformation(G_ID){
    let data = {
      G_ID : G_ID
    } 
    return this.httpClient.post(this.url + "guarantorTermInformation/get", data, this.options);
  }

  createGuarantorTermInformation(data:GuarantorAllDeposits){
    
    return this.httpClient.post<number>(this.url + "guarantorTermInformation/create/", data ,this.options);
  }

  updateGuarantorTermInformation(data:GuarantorAllDeposits){
    return this.httpClient.post<number>(this.url + "guarantorTermInformation/update/", data ,this.options);
  }



  getGuarantorCurrentInformation(G_ID){
    let data = {
      G_ID : G_ID
    } 
    return this.httpClient.post(this.url + "guarantorCurrentInformation/get", data, this.options);
  }

  createGuarantorCurrentInformation(data:GuarantorAllDeposits){
    
    return this.httpClient.post<number>(this.url + "guarantorCurrentInformation/create/", data ,this.options);
  }

  updateGuarantorCurrentInformation(data:GuarantorAllDeposits){
    return this.httpClient.post<number>(this.url + "guarantorCurrentInformation/update/", data ,this.options);
  }


  getGuarantorRecurringInformation(G_ID){
    let data = {
      G_ID : G_ID
    } 
    return this.httpClient.post(this.url + "guarantorRecurringInformation/get", data, this.options);
  }

  createGuarantorRecurringInformation(data:GuarantorAllDeposits){
    
    return this.httpClient.post<number>(this.url + "guarantorRecurringInformation/create/", data ,this.options);
  }

  updateGuarantorRecurringInformation(data:GuarantorAllDeposits){
    return this.httpClient.post<number>(this.url + "guarantorCurrentInformation/update/", data ,this.options);
  }
  ...
  getGuarantorCreditInformation(G_ID){
    let data = {
      G_ID:G_ID
    } 
    return this.httpClient.post(this.url + "guarantorCredit/get", data, this.options);
  }

  createGuarantorCreditInformation(data: GuarantorCredit){
    return this.httpClient.post(this.url + "guarantorCredit/create", data, this.options);
  }

  updateGuarantorCreditInformation(data: GuarantorCredit){
    
    return this.httpClient.post<number>(this.url + "guarantorCredit/update/", data , this.options);
  }


  getGuarantorCreditLoanFromThisBank(G_ID){
    let data = {
      G_ID : G_ID
    } 
    return this.httpClient.post(this.url + "gcLoanFromThisBank/get", data, this.options);
  }

  createGuarantorCreditLoanFromThisBank(data:GcLoanFromThisBank){
    
    return this.httpClient.post<number>(this.url + "gcLoanFromThisBank/create/", data ,this.options);
  }

  updateGuarantorCreditLoanFromThisBank(data:GcLoanFromThisBank){
    return this.httpClient.post<number>(this.url + "gcLoanFromThisBank/update/", data ,this.options);
  }


  getGuarantorCreditLoanFromOtherBank(G_ID){
    let data = {
      G_ID : G_ID
    } 
    return this.httpClient.post(this.url + "gcLoanFromOtherBank/get", data, this.options);
  }

  createGuarantorCreditLoanFromOtherBank(data:GcLoanFromOthersBank){
    
    return this.httpClient.post<number>(this.url + "gcLoanFromOtherBank/create/", data ,this.options);
  }

  updateGuarantorCreditLoanFromOtherBank(data:GcLoanFromOthersBank){
    return this.httpClient.post<number>(this.url + "gcLoanFromOtherBank/update/", data ,this.options);
  }


  getGuarantorCreditLoanGuarantee(G_ID){
    let data = {
      G_ID : G_ID
    } 
    return this.httpClient.post(this.url + "gcLoanGuarantee/get", data, this.options);
  }

  createGuarantorCreditLoanGuarantee(data:GcLoanGuarantee){
    
    return this.httpClient.post<number>(this.url + "gcLoanGuarantee/create/", data ,this.options);
  }

  updateGuarantorCreditLoanGuarantee(data:GcLoanGuarantee){
    return this.httpClient.post<number>(this.url + "gcLoanGuarantee/update/", data ,this.options);
  }


  getGuarantorCreditPreviousLoan(G_ID){
    let data = {
      G_ID : G_ID
    } 
    return this.httpClient.post(this.url + "gcPreviousLoan/get", data, this.options);
  }

  createGuarantorCreditPreviousLoan(data:GcPreviousLoan){
    
    return this.httpClient.post<number>(this.url + "gcPreviousLoan/create/", data ,this.options);
  }

  updateGuarantorCreditPreviousLoan(data:GcPreviousLoan){
    return this.httpClient.post<number>(this.url + "gcPreviousLoan/update/", data ,this.options);
  }


  getGuarantorProperty(G_ID){
    let data = {
      G_ID : G_ID
    } 
    return this.httpClient.post(this.url + "guarantorProperty/get", data, this.options);
  }

  createGuarantorProperty(data:GuarantorProperty){
    
    return this.httpClient.post<number>(this.url + "guarantorProperty/create/", data ,this.options);
  }

  updateGuarantorProperty(data:GuarantorProperty){
    return this.httpClient.post<number>(this.url + "guarantorProperty/update/", data ,this.options);
  }



  getGuarantorPropertiesToAdd(G_ID){
    let data = {
      G_ID : G_ID
    } 
    return this.httpClient.post(this.url + "guarantorSubProperty/get", data, this.options);
  }

  createGuarantorPropertiesToAdd(data:GuarantorSubproperty){
    
    return this.httpClient.post<number>(this.url + "guarantorSubProperty/create/", data ,this.options);
  }

  updateGuarantorPropertiesToAdd(data:GuarantorSubproperty){
    return this.httpClient.post<number>(this.url + "guarantorSubProperty/update/", data ,this.options);
  }
  ...
  sendToLocalBoard(amount: number, proposalId: number, currentStageId: number, nextStageId: number, remark: string, resolution_date): Observable<number>{
    var data = {
    ...
    return this.httpClient.post<number>(this.url + "praposal/uupdateProposalInfo", JSON.stringify(data), this.options);
  }
  ...
  getgIncomeInformation(G_ID){
    let data = {
      G_ID:G_ID
    } 
    return this.httpClient.post(this.url + "guarantorIncome/get", data, this.options);
  }

  creategIncomeInformation(data: GuarantorIncome){
    return this.httpClient.post(this.url + "guarantorIncome/create", data, this.options);
  }

  updategIncomeInformation(data: GuarantorIncome){
    
    return this.httpClient.post<number>(this.url + "guarantorIncome/update/", data , this.options);
  }


  // updateGuarantorInformation1(data:GuarantorMain){
  //   return this.httpClient.post(this.url + "guarantorMain/update", data, this.options);
  // }
  ...
  getGuarantorInformation1(data:Sort){
    // let data = {
    //   PROPOSAL_ID:PROPOSAL_ID
    // }
    return this.httpClient.post(this.url + "guarantorMain/get", data, this.options);
  }

  createGuarantorInformation1(data:GuarantorMain){
    return this.httpClient.post(this.url + "guarantorMain/create", data, this.options);
  }
  ...
  getGuarantorPersonal(G_ID){
    let data = {
      G_ID:G_ID
    }
    return this.httpClient.post(this.url + "guarantorPersonal/get", data, this.options);
  }

  createGuarantorPersonal(data:GuarantorPersonal){
    return this.httpClient.post(this.url + "guarantorPersonal/create", data, this.options);
  }

  updateGuarantorPersonal(data:GuarantorPersonal){
    return this.httpClient.post(this.url + "guarantorPersonal/update", data, this.options);
  }
  ...
  getAlldepositLoan(pageIndex: number, pageSize: number, sortKey: string, sortValue: string, filter: string): Observable<Goldloan[]> {
    var data = {
      pageIndex: pageIndex,
      pageSize: pageSize,
      sortKey: sortKey,
    ...
    return this.httpClient.post<Goldloan[]>(this.url + "depositLoanInformation/get", JSON.stringify(data), this.options);
  }

  createdepositLoan(GoldLoan): Observable<number> {

    GoldLoan.CLIENT_ID = this.clientId;

    return this.httpClient.post<number>(this.url + "depositLoanInformation/create/", JSON.stringify(GoldLoan), this.options);
  }

  updatedepositLoan(GoldLoan): Observable<number> {

    GoldLoan.CLIENT_ID = this.clientId;

    return this.httpClient.put<number>(this.url + "depositLoanInformation/update/", JSON.stringify(GoldLoan), this.options);
  }
  ...
  //   data.CLIENT_ID = this.clientId;
  //   return this.httpClient.post(this.url+'amulya/create',JSON.stringify(data),this.options);
  // }

  addGuarantorInfo_Amulya(data:GnGuarantor){
   
    return this.httpClient.post(this.url+'guarantorAmulya/create',JSON.stringify(data),this.options);
  }

  addGuarantorPersonal_Amulya(data:GnPersonal){
    return this.httpClient.post(this.url+'amulyaGuarantorPersonal/create',JSON.stringify(data),this.options)
  }

  addGuarantorProperty_Amulya(data:GnProperty){
    return this.httpClient.post(this.url+'amulyaGuarantorProperty/create',JSON.stringify(data),this.options)
  }

 

  addBanker_Amulya(data:Banker){
    return this.httpClient.post(this.url+'amulyaGuarantorPersonalBanker/create',JSON.stringify(data),this.options)
  }

  addEmployer_Amulya(data:Employer){
    return this.httpClient.post(this.url+'amulyaGuarantorPersonalEmployer/create',JSON.stringify(data),this.options)
  }

  getLoanSpecificInfo_Amulya(data:Sort){


    return this.httpClient.post(this.url+'amulya/get',JSON.stringify(data),this.options);
  }

  getAllGuarantorInfo_Amulya(data:Sort){
   
    return this.httpClient.post(this.url+'guarantorAmulya/get',JSON.stringify(data),this.options);
  }

  getGuarantorPersonal_Amulya(data:GIDSort){
    return this.httpClient.post(this.url+'amulyaGuarantorPersonal/get',JSON.stringify(data),this.options)
  }

  getAllGuarantorProperty_Amulya(data:GIDSort){
    return this.httpClient.post(this.url+'amulyaGuarantorProperty/get',JSON.stringify(data),this.options)
  }

  getAllBanker_Amulya(data:GIDSort){
    
    return this.httpClient.post(this.url+'amulyaGuarantorPersonalBanker/get',JSON.stringify(data),this.options)
  }

  getAllEmployer_Amulya(data:GIDSort){
  
    return this.httpClient.post(this.url+'amulyaGuarantorPersonalEmployer/get',JSON.stringify(data),this.options)
  }
  ...
  //   return this.httpClient.put(this.url+'amulya/update',JSON.stringify(data),this.options);
  // }

  UpdateGuarantorInfo_Amulya(data:GnGuarantor){
   
    return this.httpClient.put(this.url+'guarantorAmulya/update',JSON.stringify(data),this.options);
  }

  UpdateGuarantorPersonal_Amulya(data:GnPersonal){
    return this.httpClient.put(this.url+'amulyaGuarantorPersonal/update',JSON.stringify(data),this.options)
  }

  UpdateGuarantorProperty_Amulya(data:GnProperty){
    return this.httpClient.put(this.url+'amulyaGuarantorProperty/update',JSON.stringify(data),this.options)
  }



  UpdateBanker_Amulya(data:Banker){
    return this.httpClient.put(this.url+'amulyaGuarantorPersonalBanker/update',JSON.stringify(data),this.options)
  }

  UpdateEmployer_Amulya(data:Employer){
    return this.httpClient.put(this.url+'amulyaGuarantorPersonalEmployer/update',JSON.stringify(data),this.options)
  }
