...
import { GuarantorNewInfoComponent } from '../../GuarantorNew/guarantor-new-info/guarantor-new-info.component';
...
export class PersonalproposalComponent implements OnInit {
  ...
  @ViewChild(GuarantorComponent) gurantorInfo: GuarantorComponent;
