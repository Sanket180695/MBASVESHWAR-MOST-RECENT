...
export class CreditInfoComponent implements OnInit {
    ...
    this.api.getAllEarlierLoanHistory(0, 0, 'ID', "asc", "AND CREDIT_INFORMATION_ID = " + this.data.ID + " AND ARCHIVE_FLAG = 'F'")
      .subscribe(successCode => {
        ...
        if (successCode['code'] == "200" && successCode['count'] > 0) {
          ...
          for(let i=0; i < successCode['data'].length; i++){
            successCode['data'][i]['PURPOSE_OF_LOAN'] = Number(successCode['data'][i]['PURPOSE_OF_LOAN'])
          }
  ...
  add1(is_sub: boolean) {
    ...
    if (is_sub) {
      this.drawerTitle1 = this.api.translate.instant('gcreditinfo.drawerTitle1');
      this.drawerData1.IS_SUB = true;
      this.drawerData1.BANK_OR_INSTITUTE_NAME = this.api.translate.instant('gcreditinfo.name');
  ...
  edit1(data: any): void {
    if (data.IS_SUB) {
      this.loans = this.loanData2;
      this.drawerTitle1 = this.api.translate.instant('gcreditinfo.drawerTitle3');
    }
    else {
  ...
  add2(is_sub2: boolean) {
    ...
    if (is_sub2) {
      this.drawerTitle2 = this.api.translate.instant('gcreditinfo.drawerTitle5');
  ...
  edit2(data: any): void {
    if (data.IS_SUB) {
      this.loans2 = this.loanData2;
      this.drawerTitle2 = this.api.translate.instant('gcreditinfo.drawerTitle7');
    }
    else {
      this.loans2 = this.loanData2;
  ...
  add3(is_sub3: boolean) {
    ...
    this.loans = this.loanData2;
    if (is_sub3) {
      this.drawerTitle3 = this.api.translate.instant('gcreditinfo.drawerTitle9');
  ...
  edit3(data: any): void {
    this.loans = this.loanData2;
    if (data.IS_SUB)
      this.drawerTitle3 = this.api.translate.instant('gcreditinfo.drawerTitle11');
    else
