...
export class FinancialinfoComponent implements OnInit {
  ...
  // saveWorkdata6(): void {
  //   // if (this.index > -1) {
  //   //   this.dataList8[this.index] = Object.assign({}, this.drawerData8);
  //   // } else {
  //   //   this.dataList8.push(Object.assign({}, this.drawerData8));
  //   // }
  //   // console.log("ppppppppppppppppppp",this.dataList8)
 ...
 edit3(data: FRecurringDeposit, i: number): void {
  ...
  // edit3(data: FRecurringDeposit, i: number): void {
  //   this.index = i;
  //   this.drawerTitle5 = this.api.translate.instant('cash-credit-loan-other.title6');
  //   this.drawerData5 = Object.assign({}, data);
  //   this.drawerVisible5 = true;
  ...
  // add1(): void {
  //   this.drawerTitle5 = this.api.translate.instant('cash-credit-loan-other.title5');
  //   this.drawerData5 = new FRecurringDeposit();
  //   this.drawerVisible5 = true;
  //   this.logtext = 'ADD - CashCreditOther form KEYWORD [A - CashCreditOther] ';
  //   this.api.addLog('A', this.logtext, this.api.emailId)
  ...
  //         }
  //         if(this.data.PIGMY_DEPOSIT.length == 0){
  //           this.data.IS_HAVE_PIGMY = false
  //         }

  //         this.api.updateFinancialDepositInfo(data).subscribe(
  //           (res) =>{
  //             console.log(res);
  ...
  // edit5(data: FRecurringDeposit, i: number): void {
  //   this.index = i;
  //   this.drawerTitle4 = this.api.translate.instant('cash-credit-loan-other.title4');
  //   this.drawerData6 = Object.assign({}, data);
  //   this.drawerVisible4 = true;
  ...
  // add4(): void {
  //   this.drawerTitle4 = this.api.translate.instant('cash-credit-loan-other.title3');
  //   this.drawerData6 = new FRecurringDeposit();
  //   this.drawerVisible4 = true;
  //   this.logtext = 'ADD - CashCreditOther form KEYWORD [A - CashCreditOther] ';
  //   this.api.addLog('A', this.logtext, this.api.emailId)
  ...
  // }
  // add5(): void {
  //   this.drawerTitle4 = this.api.translate.instant('cash-credit-loan-other.title7');
  //   this.drawerData8 = new FRecurringDeposit();
  ...
  // edit6(data: FRecurringDeposit, i: number): void {
  //   this.index = i;
  //   this.drawerTitle5 = this.api.translate.instant('cash-credit-loan-other.title2');
  //   this.drawerData8 = Object.assign({}, data);
  //   this.drawerVisible6 = true;
  ...
  loadData() {
    ...
    //     this.dataList = this.FinanceData['RECURING_DEPOSIT']
    //     this.dataList22 = this.FinanceData['CURRENT_DEPOSIT'] 
    //     this.dataList8 = this.FinanceData['PIGMY_DEPOSIT']
    //     this.isSpinning = false
    //     console.log(this.FinanceData, "finanacial")
    //     console.log(data)
