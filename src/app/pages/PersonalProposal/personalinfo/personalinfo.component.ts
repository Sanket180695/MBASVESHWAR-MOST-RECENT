...
export class PersonalinfoComponent implements OnInit {
  ...
  // table = {
  //   data: [
  //     { NAME: '', RELATION: '', OCCUPATION: '', YEARLY_INCOME:0 , HADDRESS: '', GENDER: 'M', OCCUPATIONS: '' },
  //     { NAME: '', RELATION: '', OCCUPATION: '', YEARLY_INCOME: 0, HADDRESS: '', GENDER: 'F', OCCUPATIONS: '' },
  ...
  addData() {
    if (this.NAME != undefined && this.RELATION != undefined && this.OCCUPATION != undefined && this.YEARLY_INCOME != undefined && this.HADDRESS != undefined && this.OCCUPATIONS != undefined && this.GENDER != undefined) {
      ...
      if (this.index1 > -1) {
        ...
        this.familyDetils[this.index1]['HADDRESS'] = this.HADDRESS;
        this.familyDetils[this.index1]['OCCUPATIONS'] = this.OCCUPATIONS;
        this.familyDetils[this.index1]['GENDER'] = this.GENDER;
      ...
      if (oks) {
        ...
        this.api.updatePersonalInformation(this.data)
          .subscribe(successCode => {
            ...
            if (successCode['code'] == "200") {
              if (this.addressinfoCurrent.VILLAGE != undefined && this.addressinfoCurrent.STATE != undefined &&
                this.addressinfoCurrent.VILLAGE != '' && this.addressinfoCurrent.STATE != '' &&
                this.addressinfoPermanent.VILLAGE != '' && this.addressinfoPermanent.STATE != '' &&
                this.addressinfoPermanent.VILLAGE != undefined && this.addressinfoPermanent.STATE != undefined) {
