...
export class NewproposalComponent implements OnInit {
  ...
  // addressinfoCurrent.STATE:string='Karnataka';
  ...
  save() {
    ...
    for (let i = 0; i < this.branchData.length; i++) {
      if (this.branchData[i].ID == this.data.BRANCH_ID) {
        this.data.BRANCH_NAME = this.branchData[i].NAME_MR;
...

    {
      if (this.data.PRAPOSAL_TYPE == 'वैयक्तिक') {
        ...
        if (this.data.APPLICANT_MIDDLE_NAME == undefined || this.data.APPLICANT_MIDDLE_NAME.trim() == '') {
          Isok = false;
          //this.message.error(this.api.translate.instant('basicinfo.message1'), "");
        }

        if (this.data.APPLICANT_LAST_NAME == undefined || this.data.APPLICANT_LAST_NAME.trim() == '') {
          Isok = false;
          //this.message.error(this.api.translate.instant('basicinfo.message1'), "");
        }
        ...
        this.data.APPLICANT_MIDDLE_NAME = ''
        this.data.APPLICANT_LAST_NAME = ''
        this.data.DOB = null
        this.data.GENDER = "M"
        this.data.CAST = ''
        this.data.PAN = ''
