...
import { SendFromLocalBoardToHoComponent } from '../../PersonalProposal/send-from-local-board-to-ho/send-from-local-board-to-ho.component';
import { SendToValuationStageComponent } from '../../PersonalProposal/send-to-valuation-stage/send-to-valuation-stage.component';
import { SendToLegalOpinionComponent } from '../../PersonalProposal/send-to-legal-opinion/send-to-legal-opinion.component';
...
export class ProposalsallComponent implements OnInit {
  ...
  tempVariable = `${this.drawerData.APPLICANT_NAME} ${this.drawerData.APPLICANT_MIDDLE_NAME} ${this.drawerData.APPLICANT_LAST_NAME}`
  ...
  @ViewChild(SendFromLocalBoardToHoComponent) localBoard : SendFromLocalBoardToHoComponent;
  @ViewChild(SendToValuationStageComponent) valuationStage : SendToValuationStageComponent;
  @ViewChild(SendToLegalOpinionComponent) legalOpinion : SendToLegalOpinionComponent;
  ...
  drawerVisibleLegalOpinion : boolean;
  drawerTitleLegalOpinion : string;
  drawerDataLegalOpinion : Proposal = new Proposal();
  ...
  ngOnInit() {
    ...
    // if (this.browserLang == 'mr') {
    //   this.columns = [['LOAN_KEY', this.api.translate.instant('proposalsall.columns1')],   ['LOAN_TYPE_NAME', this.api.translate.instant('proposalsall.columns3')], ['LOAN_AMOUNT', this.api.translate.instant('proposalsall.columns4')], [this.tempVariable, this.api.translate.instant('proposalsall.columns5')], ['BRANCH_NAME', this.api.translate.instant('proposalsall.columns6')],['MOBILE_NUMBER', this.api.translate.instant('proposalsall.columns7')],   ['AGE', this.api.translate.instant('proposalsall.columns10')],   ['CREATED_ON_DATETIME', this.api.translate.instant('proposalsall.columns14')], ['LAST_UPDATED_ON_DATETIME', this.api.translate.instant('proposalsall.columns15')]]
    // } else if (this.browserLang == 'en') {
    //   this.columns = [['LOAN_KEY', this.api.translate.instant('proposalsall.columns1')],   ['LOAN_TYPE_NAME_EN', this.api.translate.instant('proposalsall.columns3')], ['LOAN_AMOUNT', this.api.translate.instant('proposalsall.columns4')], [this.tempVariable, this.api.translate.instant('proposalsall.columns5')], ['BRANCH_NAME_EN', this.api.translate.instant('proposalsall.columns6')], ['MOBILE_NUMBER', this.api.translate.instant('proposalsall.columns7')],   ['AGE', this.api.translate.instant('proposalsall.columns10')],   ['CREATED_ON_DATETIME', this.api.translate.instant('proposalsall.columns14')], ['LAST_UPDATED_ON_DATETIME', this.api.translate.instant('proposalsall.columns15')]]
    // } else {
    //   this.columns = [['LOAN_KEY', this.api.translate.instant('proposalsall.columns1')],   ['LOAN_TYPE_NAME_KN', this.api.translate.instant('proposalsall.columns3')], ['LOAN_AMOUNT', this.api.translate.instant('proposalsall.columns4')], [this.tempVariable, this.api.translate.instant('proposalsall.columns5')], ['BRANCH_NAME_KN', this.api.translate.instant('proposalsall.columns6')], ['MOBILE_NUMBER', this.api.translate.instant('proposalsall.columns7')],   ['AGE', this.api.translate.instant('proposalsall.columns10')],   ['CREATED_ON_DATETIME', this.api.translate.instant('proposalsall.columns14')], ['LAST_UPDATED_ON_DATETIME', this.api.translate.instant('proposalsall.columns15')]]
    // }
    this.search();
  ...
  //     this.dataListLocalBoard = data['data']
  ...
  sendToHo(data: Proposal): void {
    // this.drawerTitleLocalBoard = this.api.translate.instant('');
    this.drawerDataLocalBoard = Object.assign({}, data);
    this.drawerVisibleLocalBoard = true;
    this.localBoard.reset()
    this.localBoard.getUrl(this.api.chatbotUrl + "userresponses/" + data.BOT_REPLY_ID)
    
  }

  get closeCallBack11() {
    return this.draweCloseLocalBoard.bind(this);

  }

  draweCloseLocalBoard(): void {
    this.search(true)
    this.drawerVisibleLocalBoard = false;
  ...
  sendToLegalOpinion(data: Proposal): void {
    this.drawerDataLegalOpinion = Object.assign({}, data);
    this.drawerVisibleLegalOpinion = true;
    this.drawerTitleLegalOpinion = this.api.translate.instant('cibilchecking.send_to_legal_opinion_stage');
  }

  get closeCallBack13() {
    return this.drawerCloseLegalOpinion.bind(this);
  }

  drawerCloseLegalOpinion(): void {
    this.search(true)
    this.drawerVisibleLegalOpinion = false;
  }
  ...
  downloadForm3(file, key, name,i) {
    this.dataList[i].loadingRecords3 = true
    this.api.getFile(file)
      .subscribe(data => {
        this.dataList[i].loadingRecords3 = false
        if (data['code'] == "200") {
          const TYPED_ARRAY = new Uint8Array(data['data']['FILE_DATA']['data']);
          const STRING_CHAR = TYPED_ARRAY.reduce((data, byte) => {
            return data + String.fromCharCode(byte);
  ...
  downloadForm4(file, key, name,i) {
    this.dataList[i].loadingRecords4 = true
    this.api.getFile(file)
      .subscribe(data => {
        this.dataList[i].loadingRecords4 = false
        if (data['code'] == "200") {
          const TYPED_ARRAY = new Uint8Array(data['data']['FILE_DATA']['data']);
          const STRING_CHAR = TYPED_ARRAY.reduce((data, byte) => {
            return data + String.fromCharCode(byte);
  ...
  downloadForm5(file, key, name,i) {
    this.dataList[i].loadingRecords5 = true
    this.api.getFile(file)
      .subscribe(data => {
        this.dataList[i].loadingRecords5 = false
        if (data['code'] == "200") {
          const TYPED_ARRAY = new Uint8Array(data['data']['FILE_DATA']['data']);
          const STRING_CHAR = TYPED_ARRAY.reduce((data, byte) => {
            return data + String.fromCharCode(byte);
