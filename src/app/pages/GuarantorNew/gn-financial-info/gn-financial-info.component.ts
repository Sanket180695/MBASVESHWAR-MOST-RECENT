...
@Component({
  selector: 'app-gn-financial-info',
  templateUrl: './gn-financial-info.component.html',
  styleUrls: ['./gn-financial-info.component.css']
})
export class GnFinancialInfoComponent implements OnInit {
