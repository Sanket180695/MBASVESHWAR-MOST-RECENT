...
import { GnPersonalInfoComponent } from '../gn-personal-info/gn-personal-info.component';
import { GnPropertyInfoComponent } from '../gn-property-info/gn-property-info.component';
import { GnFinancialInfoComponent } from '../gn-financial-info/gn-financial-info.component';
import { GnDocumentInfoComponent } from '../gn-document-info/gn-document-info.component';
...
@Component({
  selector: 'app-gn-proposal-info',
  templateUrl: './gn-proposal-info.component.html',
  styleUrls: ['./gn-proposal-info.component.css']
})
export class GnProposalInfoComponent implements OnInit {
  ...
  @Output() changeName:EventEmitter<GnGuarantor> = new EventEmitter<GnGuarantor>();
  ...
  applicantId: number
  @ViewChild(GnPersonalInfoComponent) personalinfo1: GnPersonalInfoComponent;

  IsSubmit = false
  @Input() CURRENT_STAGE_ID: number;
  @Input() IS_APPROVED:number;
  @ViewChild(GnPropertyInfoComponent) property: GnPropertyInfoComponent;
  @ViewChild(GnFinancialInfoComponent) finanace: GnFinancialInfoComponent;
  @ViewChild(GnDocumentInfoComponent) document: GnDocumentInfoComponent;
  selectedIndex = 0
...
loadAllExtraInformationMapped(data: GnCoborrower, data1: Proposal) {
  //console.log(data)
  //console.log(data1)
