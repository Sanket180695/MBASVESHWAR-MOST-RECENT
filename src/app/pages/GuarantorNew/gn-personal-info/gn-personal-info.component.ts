...
@Component({
  selector: 'app-gn-personal-info',
  templateUrl: './gn-personal-info.component.html',
  styleUrls: ['./gn-personal-info.component.css']
})
export class GnPersonalInfoComponent implements OnInit {
  @Output() demo: EventEmitter<boolean> =
    new EventEmitter<boolean>();
  @Input() CURRENT_STAGE_ID: number;
  @Input() GuarantorData: GnGuarantor;
  ...
  banker: Banker[] = [];
  employer: Employer[] = [];
  personalInfo: GnPersonal = new GnPersonal();
  ...
  getGuarantorPersonal() {
    this.personalInfo = new GnPersonal();
    let sortkey: GIDSort = {
