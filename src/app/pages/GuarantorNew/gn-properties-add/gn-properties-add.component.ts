...
@Component({
  selector: 'app-gn-properties-add',
  templateUrl: './gn-properties-add.component.html',
  styleUrls: ['./gn-properties-add.component.css']
})
export class GnPropertiesAddComponent implements OnInit {
  ...
  GuarantorData: GnGuarantor = new GnGuarantor();

  propertyInfo: GnProperty = new GnProperty();
